...
NORM_STATS = {
    ...
    "action": {
        "mean": [
            0.0030841389670968056,
            0.006400584243237972,
            -0.006992667447775602,
            -0.009621165692806244,
            0.0033867715392261744,
            -0.02155510149896145,
            0.003844755468890071,
        ],
        "std": [
            0.1866438388824463,
            0.13990944623947144,
...
class OpenPi(nn.Module):
    def __init__(self, cfg):
        ...
        try:
            self.tokenizer = AutoTokenizer.from_pretrained("google/paligemma-3b-pt-224", padding_side="right")
        except OSError:
        ...
        print("✓ PI05Policy (Manual Pipeline Fixed) 初始化完成")
    ...
    def preprocess_inputs(self, observation, tasks):
        ...
        tokens = self.tokenizer(
            tasks, padding="max_length", max_length=self.max_len, truncation=True, return_tensors="pt"
        )
